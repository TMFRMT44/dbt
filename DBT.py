...
# Vous pouvez aussi ajouter d'autres commandes Git de la même manière
subprocess.run(["git", "add", "."])
subprocess.run(["git", "commit", "-m", "Premier commit"])
...
git branch -M main
git remote add origin git@github.com:TMFRMT44/dbt_project.git
